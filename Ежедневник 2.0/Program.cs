...
void text_zametki()
{
    zam1.nazvanie1 = "Сходить в качалку";
    zam1.opisanie1 = "Потренироваться и сходить в душ";
    zam1.nazvanie2 = "Сходить на работу";
    zam1.opisanie2 = "Проснуться, одеться поесть и поехать на работу на метро к 10-00";
    zam[0] = zam1;
    zam2.nazvanie1 = "Посмотреть лекции";
    zam2.opisanie1 = "Зайти в классрум и посмотреть лекции";
    zam2.nazvanie2 = "Погулять с девушкой";
    zam2.opisanie2 = "Съездить на Арбат и погулять";
    zam[1] = zam2;
    ...
    zam[3] = zam4;
    zam5.nazvanie1 = "Написать практос";
    zam5.opisanie1 = "Сесть за пк и написать код на C#";
...
void data1()
{
    ...
    if (data < 10)
    {
        Console.WriteLine("Выбранная дата: " + "0" + data + ".10.2023 г.");
    }
    else if (data == 10)
    {
        Console.WriteLine("Выбранная дата: " + data + ".10.2023 г.");
    }
    else if (data > 10)
    {
        Console.Write("Выбранная дата: " + data + ".10.2023 г.");
    }
    if (data < 6)
    {
...
void nalichie()
{
    ...
    if (position == 0)
    {
        ...
        Console.Write("Дата: " + "0" + data + ".10.2023" + " 09:00:00");
    ...
    else
    {
        ...
        Console.Write("Дата: " + "0" + data + ".10.2023" + " 15:00:00");
